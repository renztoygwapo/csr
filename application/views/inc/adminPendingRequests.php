                ...
                <div class="col-md-12">
                    <div class="tabs-framed">
                        <ul class="tabs clearfix">
                            <li class="active"><a href="#tab-1" data-toggle="tab"  onclick="changeTab(1)">Pending Requests</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="bg-orange">Date Deadline</th>
                                            <th class="bg-orange">Request Party</th>
                                            <th class="bg-orange">Request Description</th>
                                    ...
                                    <tbody id="temp_result">
                                        <?php
                                        $ctr=0;
                                            foreach ($pendingRequests as $keys => $det) {
                                                $ctr++;
                                                ?>
                                                <tr>
                                            <td><?=$ctr?>.</td>
                                            <td><?=$det->date_received?></td>
                                            <td><?=$det->date_deadline?></td>
                                            <td><?=$det->request_party?></td>
                                            <td><?=$det->request_description?></td>
                                            <td><?=$det->requestor_First_name?> <?=$det->requestor_Last_name?> </td>
                                            <td>
                                                <center>
                                                    <a href="<?=base_url('home/request_details/deside')?>/<?=$det->request_id?>/<?=$det->requestor_id?>" title="View"><i class="fa fa-eye"></i></a>
                                                </center>
                                            </td>
                                        </tr>
                                                <?php
...
<script>
                function add_socialMedia() {
                    ...
                    function get_pendings () {
                       ...
                       $.ajax({
                                      type: 'POST',
                                      url: "<?= site_url('admin/get_pendings') ?>",
                                      data: {
                                        sql:sql
