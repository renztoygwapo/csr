                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="input">
                                                            ...
                                                            <input type="text" name="firstname" value="<?=$requestor_First_name?>" disabled>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="input">
                                                            <i class="icon-append fa fa-user"></i>
                                                            <input type="text" name="middlename" value="<?=$requestor_Middle_name?>" disabled>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="input">
                                                            <i class="icon-append fa fa-user"></i>
                                                            <input type="text" name="lastname" value="<?=$requestor_Last_name?>" disabled>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="input">
                                                            ...
                                                            <input type="text" name="contact" value="<?=$requestor_contact?>" disabled>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="input">
                                                            ...
                                                            <input type="text" name="payee_address" value="<?=$requestor_address?>" disabled>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="input">
                                                            <i class="icon-append fa fa-home"></i>
                                                            <input type="text" id="input_affiliation" name="payee_affiliation" placeholder="" onkeyup="get_sub_affiliation()" required>
                                                            <b class="tooltip tooltip-bottom-right">Affiliation</b>
                                                        </label>
                                                        <div class="widget">
                                                            <ul class="categories" id="sub_affiliation">
                                                            </ul>                       
                                                        </div>
                                                    </div>               
                                                </div>
...
<script>
    ...
    function addnow() {
        ...
        if (kinds !== "/wala" && nature !== "/wala") {
            var att = document.createAttribute('action');
            att.value = "<?= site_url('staff/do_addRequest_old/'.$requestor_id) ?>" + "/" + quantity + kinds + "/" + nature+"/"+affiliation_id;
            document.getElementById("RequestForm").setAttributeNode(att);
        }
    }
    var affiliation_id="none"
    function affiliation_select(id,value) {
        affiliation_id=id;
        document.getElementById('input_affiliation').value=value;
        var h1=document.getElementById('sub_affiliation');
        h1.innerHTML="";
    }
    function get_sub_affiliation() {
        var search_affiliation=document.getElementById('input_affiliation').value;
        var h1=document.getElementById('sub_affiliation');
        h1.innerHTML="";
        affiliation_id="none";
        $.ajax({
            type: 'POST',
            url: "<?= site_url('staff/get_sub_affiliation/'.$requestor_id) ?>",
            data: {
